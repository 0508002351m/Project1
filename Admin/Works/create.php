   ...
   if (!Validate($_FILES['image']['name'],1)) {
    ...
    if (count($errors) > 0) {
       ...
       if(move_uploaded_file($ImgTempPath,$disPath)){
        ...
        $sql = "insert into talent_work (Name,Content,Image,User_id,Cat_id) values ('$name','$FinalConName','$FinalName','$id','$cat_id')";
            ...
            <div class="card-body">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" value="<?php echo $data['id'];?>"><?php echo $data['Name'];?>
                    </div> -->
