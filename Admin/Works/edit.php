...
<main>
    <div class="container-fluid">
        ...
        <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Dashboard/Works/Edit</li>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <form action="edit.php?id=<?php echo $UserData['id']; ?>" method="post" enctype="multipart/form-data">
                    ...
                    <embed src="./files/<?php echo $UserData['Content']; ?>" alt="" height="50px" width="50px"></embed> <br>
